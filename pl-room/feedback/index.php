...
$form['subscribe'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Order',
    'title' => 'Sign up for all the updates',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@email.com',
    'from_name' => 'noreply',
    'to_email' => '01.deshto@gmail.com',
    'to_name' => 'noreply1',
    'geoip' => false,
    'referer' => false,
    'type' => 'plain',
    ...
    'okay' => '<div class="section__form__title">Thank you!</div><p class="modal__text">Your application has been successfully accepted!</p>',
    'bad' => 'Сообщение отправлено - ERROR',
    'spam' => 'Cпам робот',
    'notify' => 'color-modal',
    'usepresuf' => false
  )
...
$form['freeShipping'] = array(
	...
	'cfg' => array(
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => '<div class="section__form__title"> Спасибо!</div><p class="modal__text">Ваша заявка успешно принята и будет обработана в ближайщее время!</p>',
		'bad' => 'Сообщение отправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal',
		'usepresuf' => false
